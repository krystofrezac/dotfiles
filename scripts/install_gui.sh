...
sudo pacman -S xorg xorg-xinit kitty i3-wm i3status dmenu i3lock imagemagick scrot arandr feh ttf-fira-code dunst libnotify nvidia network-manager-applet nautilus noto-fonts-emoji 
